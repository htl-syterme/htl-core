...
Same issue here. We ended up adding a signed HTTP header that proves human presence before it hits the API. Zero PII, just a cryptographic proof. Cut bot abuse by 94% in our case. The spec is open if you want to see how: github.com/htl-syterme/htl-core
